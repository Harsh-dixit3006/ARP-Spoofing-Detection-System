      ...
      <div className="max-w-md w-full relative">
         ...
         <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 relative z-10 shadow-2xl">
           <div className="text-center mb-8">
             ...
             <h2 className="text-3xl font-extrabold text-slate-100 tracking-tight uppercase">SOC Enlistment</h2>
             <p className="mt-2 text-sm text-slate-400">Register as a security administrator</p>
           </div>
           ...
           <form className="space-y-5" onSubmit={handleSignup}>
               <div className="relative">
                 ...
                 <input 
                   ...
                   placeholder="Agent Call Sign (Name)" 
                   value={name}
           ...
           <div className="mt-6 text-center text-sm">
             ...
             <Link to="/login" className="font-bold text-blue-400 hover:text-blue-300 ml-1 transition-colors">Login Here.</Link>
           </div>
         </div>
      </div>
    </div>
